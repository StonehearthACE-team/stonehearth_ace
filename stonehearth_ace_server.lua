...
local monkey_patches = {
   ...
   ace_build_ladder_adjacent_action = 'stonehearth.ai.actions.build_ladder_adjacent_action',
   ...
   ace_choose_location_outside_town = 'stonehearth.services.server.game_master.controllers.util.choose_location_outside_town',
   ace_chunk = 'stonehearth.components.building2.plan.chunk',
   ace_city_tier_achieved_encounter = 'stonehearth.services.server.game_master.controllers.encounters.city_tier_achieved_encounter',
   ...
   ace_create_animal_for_pasture = 'stonehearth.ai.actions.create_animal_for_pasture',
   ...
   ace_deity_town_bonus = 'stonehearth.data.town_bonuses.deity_town_bonus',
   ace_delivery_quest_encounter = 'stonehearth.services.server.game_master.controllers.encounters.delivery_quest_encounter',
   ace_dialog_tree_encounter = 'stonehearth.services.server.game_master.controllers.encounters.dialog_tree_encounter',
   ace_dig_adjacent_action = 'stonehearth.ai.actions.mining.dig_adjacent_action',
   ace_dispatch_quest_encounter = 'stonehearth.services.server.game_master.controllers.encounters.dispatch_quest_encounter',
   ...
   ace_na_deity_town_bonus = 'northern_alliance.data.town_bonuses.na_deity_town_bonus',
   ace_na_guildmaster_town_bonus = 'northern_alliance.data.town_bonuses.na_guildmaster_town_bonus',
   ace_na_valor_town_bonus = 'northern_alliance.data.town_bonuses.na_valor_town_bonus',
   ace_new_fixture_node = 'stonehearth.components.building2.plan.nodes.new_fixture_node',
   ace_new_mining_node = 'stonehearth.components.building2.plan.nodes.new_mining_node',
   ...
   ace_rc_deity_town_bonus = 'rayyas_children.data.town_bonuses.rc_deity_town_bonus',
   ace_rc_guildmaster_town_bonus = 'rayyas_children.data.town_bonuses.rc_guildmaster_town_bonus',
   ace_rc_valor_town_bonus = 'rayyas_children.data.town_bonuses.rc_valor_town_bonus',
   ...
   ace_scaffolding = 'stonehearth.components.building2.scaffolding.scaffolding',
   ace_scaffolding_region = 'stonehearth.components.building2.scaffolding.scaffolding_region',
   ...
   ace_town_upgrade_choice_encounter = 'stonehearth.services.server.game_master.controllers.encounters.town_upgrade_choice_encounter',
   ...
   ace_traits_component = 'stonehearth.components.traits.traits_component',
   ...
   ace_turret_check_entity_targetable = 'stonehearth.ai.actions.siege.turret_check_entity_targetable',
   ...
   ace_wait_for_event_encounter = 'stonehearth.services.server.game_master.controllers.encounters.wait_for_event_encounter',
