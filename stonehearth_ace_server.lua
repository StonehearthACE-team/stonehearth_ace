...
local monkey_patches = {
   ...
   ace_arc = 'stonehearth.services.server.game_master.controllers.arc',
   ace_campaign = 'stonehearth.services.server.game_master.controllers.campaign',
   ...
   ace_combat_job = 'stonehearth.jobs.combat_job',
   ace_crafting_job = 'stonehearth.jobs.crafting_job',
   ace_cleric = 'stonehearth.jobs.cleric.cleric',
   ace_engineer = 'stonehearth.jobs.engineer.engineer',
   ...
   ace_worker = 'stonehearth.jobs.worker.worker'
}
