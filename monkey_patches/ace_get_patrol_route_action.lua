...
AceGetPatrolRoute._ace_old_start_thinking = GetPatrolRoute.start_thinking
...
AceGetPatrolRoute._ace_old_stop_thinking = GetPatrolRoute.stop_thinking
function AceGetPatrolRoute:stop_thinking(ai, entity, args)
   ...
   self:_ace_old_stop_thinking(ai, entity, args)
end
