local PetSleepInBedInBadWeather = radiant.class()

PetSleepInBedInBadWeather.name = 'sleep in bad weather'
PetSleepInBedInBadWeather.does = 'stonehearth:goto_sleep'
PetSleepInBedInBadWeather.args = {}
PetSleepInBedInBadWeather.priority = 0.5

function PetSleepInBedInBadWeather:start_thinking(ai, entity, args)
   self._ai = ai
   self._entity = entity
   self._ready = false
...
function PetSleepInBedInBadWeather:stop_thinking(ai, entity, args)
   self._ready = false
...
function PetSleepInBedInBadWeather:_destroy_recheck_timer()
...
function PetSleepInBedInBadWeather:_rethink()
...
return ai:create_compound_action(PetSleepInBedInBadWeather)
