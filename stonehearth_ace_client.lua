...
local monkey_patches = {
   ...
   ace_catalog_client_service = 'stonehearth.services.client.catalog_client.catalog_client_service',
   ...
   ace_room_tool = 'stonehearth.services.client.building.room_tool',
   ...
   ace_wall_tool = 'stonehearth.services.client.building.wall_tool',
...
local function monkey_patching()
   for from, into in pairs(monkey_patches) do
      ...
      if monkey_see and monkey_do then
         ...
         radiant.log.write_('stonehearth_ace', 0, 'ACE client ***INVALID*** monkey-patching \'' .. from .. '\' => \'' .. into .. '\'')
      end
   end
end
