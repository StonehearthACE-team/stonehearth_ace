...
local monkey_patches = {
   ...
   ace_floor_component = 'stonehearth.components.floor.floor_component',
   ace_doodad_placer = 'stonehearth.services.client.build_editor.doodad_placer',
   ace_build_service = 'stonehearth.services.server.build.build_service'
}
