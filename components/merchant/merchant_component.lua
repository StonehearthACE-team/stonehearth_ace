...
function MerchantComponent:set_merchant_data(player_id, merchant_data)
   ...
   if merchant_data.use_shop_description then
      ...
      radiant.entities.set_description(self._entity, 'i18n(stonehearth_ace:entities.humans.npc_merchant.shop_name_description)', {shop_name = merchant_data.shop_info.name})
   end
