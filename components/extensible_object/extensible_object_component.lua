...
function ExtensibleObjectComponent:create()
	...
	self._sv.extend_command = json.extend_command or 'stonehearth_ace:commands:toggle_enabled_on'
	self._sv.remove_command = json.remove_command or 'stonehearth_ace:commands:toggle_enabled_off'
	self._sv.extension_entity = json.extension_entity
	self._sv.render_model = json.render_model
