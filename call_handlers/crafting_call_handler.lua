...
function CraftingCallHandler:toggle_maintain_pause(session, response, job_alias)
   ...
   if order_list and order_list.toggle_maintain_pause then
      order_list:toggle_maintain_pause()
      return true
   end
end
